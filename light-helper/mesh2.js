...
export const light = new THREE.PointLight(0xffffff, 1000000);//点光源
...
const f2 = gui.addFolder('环境光源');
f2.add(light.position, 'x').min(10).max(1000);
f2.add(light.position, 'y').min(10).max(1000);
f2.add(light.position, 'z').min(10).max(1000);
f2.add(light, 'intensity');
