...
const p2 = new THREE.Vector3(50, 100, 0);  // 控制点1
const p3 = new THREE.Vector3(100, 0, 100);  // 控制点2  
const p4 = new THREE.Vector3(100, 0, 0);   // 终点


const curve = new THREE.CubicBezierCurve3(p1, p2, p3, p4);

const geometry = new THREE.TubeGeometry(curve, 50, 10, 10);
...
mesh.add(points2, line2); const gui = new GUI();
