...
import foundation from './foundation.js';//地基
import sideWall from './side-wall.js';//侧面墙
import behindWall from './behind-wall.js';//后墙
import frontWall from './front-wall.js';//前墙
import roof from './roof.js';//屋顶
import doorstep from './doorstep.js';//台阶
